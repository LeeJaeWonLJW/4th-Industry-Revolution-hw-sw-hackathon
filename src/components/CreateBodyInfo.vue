<template>
	<div>
		...
		<div class="jumbotron">
			...
			<div class="menu">
				<div @click="check('healthy')" class="fd-btn-sm box-shadow bg-white fd-color">건강</div>
				<div @click="check('lose_weight')" class="fd-btn-sm box-shadow bg-white fd-color">체중감량</div>
			</div>
		</div>
